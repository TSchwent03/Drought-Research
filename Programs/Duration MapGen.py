...
def duration_table_loop(SPI_time):
    ...
    try:
        ...
        while spi_key != -51:
            ...
            spi_key -= 1
            dfcsv.to_csv(rf'C:\Users\thoma\Documents\GitHub\Drought-Research\Tabular Data\Average Duration\{SPI_time}M\{spi_key/10}_{SPI_time}M_mean_duration.csv', index=False)
    except:
        return None
